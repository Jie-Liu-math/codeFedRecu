...
#initial_value_for_all=np.zeros(n)
...
######################################################################################
#tau=10
#np.savetxt('Result_FedRecur_TAU10.txt',Result_Recur,fmt="%f",delimiter=" ")     
#np.savetxt('Result_SCAFFOLD_TAU10.txt',Result_SCAFFOLD,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedLin_TAU10.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedTrack_TAU10.txt',Result_my3,fmt="%f",delimiter=" ")

######################################################################################
######################################################################################
#tau=15
#np.savetxt('Result_FedRecur_TAU15.txt',Result_Recur,fmt="%f",delimiter=" ")     
#np.savetxt('Result_SCAFFOLD_TAU15.txt',Result_SCAFFOLD,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedLin_TAU15.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedTrack_TAU15.txt',Result_my3,fmt="%f",delimiter=" ")


######################################################################################
######################################################################################
#tau=20
#np.savetxt('Result_FedRecur_TAU20.txt',Result_Recur,fmt="%f",delimiter=" ")     
#np.savetxt('Result_SCAFFOLD_TAU20.txt',Result_SCAFFOLD,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedLin_TAU20.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedTrack_TAU20.txt',Result_my3,fmt="%f",delimiter=" ")


######################################################################################
######################################################################################
#tau=5
#np.savetxt('Result_FedRecur_TAU5.txt',Result_Recur,fmt="%f",delimiter=" ")     
#np.savetxt('Result_SCAFFOLD_TAU5.txt',Result_SCAFFOLD,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedLin_TAU5.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Result_FedTrack_TAU5.txt',Result_my3,fmt="%f",delimiter=" ")
