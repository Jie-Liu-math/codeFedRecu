...
#Please select different file to generate different figures: TAU4, TAU8, TAU12, AND TAU16
    ...
    DSCMD=np.transpose(readFile('Result_FedRecu_TAU16.txt'))
    DSCMDD=np.transpose(readFile('Result_FedTrack_TAU16.txt'))
    DSCMDDD=np.transpose(readFile('Result_FedLin_TAU16.txt'))
    DSCMDDDD=np.transpose(readFile('Result_SCAFFOLD_TAU16.txt'))
    ...
    plt.savefig(fname="different_algorithm_TAU16.jpg",format="jpg", bbox_inches='tight')
    plt.savefig(fname="different_algorithm_TAU16.pdf",format="pdf", bbox_inches='tight')
    plt.show() 
