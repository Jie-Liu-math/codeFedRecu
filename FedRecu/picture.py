...
#########################################################
#Please select different file to generate different figures
    
    DSCMD=np.transpose(readFile('Result_FedRecur_TAU4.txt'))
...
#    plt.plot(x4,y4,label='SCAFFOLD',color='g',linewidth=2.2,linestyle=':')
#    plt.plot(x2,y2,label='FedTrack',color='y',linewidth=2.2,linestyle='-.')
#    plt.plot(x3,y3,label='FedLin',color='b',linewidth=2.2,linestyle='--')
#    plt.plot(x,y,label='FedRecur', color='r',linewidth=2.2,linestyle='solid')
    ...
    plt.semilogy(x,y,label='FedRecur', color='r',linewidth=2.2,linestyle='solid')
   ...
   # plt.title(r'$\mathcal{\tau}=4$',fontsize=20,y=-0.4)
    
 #   plt.tight_layout()
 #   plt.savefig("different_algorithm_TAU16.eps")
 #   plt.savefig("different_algorithm_TAU16.jpg")
 #   plt.savefig("different_algorithm_TAU16.pdf")
